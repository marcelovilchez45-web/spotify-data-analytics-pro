...
## 🛠️ Tecnologías
* **Base de Datos:** MySQL (Limpieza, Vistas Analíticas, Procedimientos).
* **Modelado:** Power BI (Esquema Estrella / Star Schema).
* **Lenguajes:** SQL, DAX.
* **Diseño UI:** Custom Dark Theme (Spotify Style).

## 📐 Arquitectura
1. **Data Foundation:** Limpieza y normalización de +8k registros en MySQL.
2. **Modeling:** Creación de tablas de dimensiones (Artista, Álbum, Track, Tiempo) y tabla de hechos.
3. **Analytics Layer:** Vistas SQL para optimizar el rendimiento de las consultas en Power BI.

## 📊 Dashboard Insights
* **Página 1 (Executive):** Análisis de KPIs macro, Top Artistas y Tendencia Histórica.
